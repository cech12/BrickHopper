...
## [26.3-4.2.0.0] - 2026-09-22
### Changed
- updated to Minecraft 26.3 (Fabric 0.161.0+26.3, NeoForge 26.3.0.8-beta, Forge 66.0.2)
...
### Fixed
- shift click an item stack into a brick hopper with said item already in it deleted the item stack (NeoForge) (thanks to Benassi for the report) https://github.com/cech12/WoodenHopper/issues/50
...
- fixed version number on release file
...
### Fixed
- Brick Hopper recipe advancement triggered with first inventory change (Fabric/Quilt)

## [1.20.4-2.2.0.1] - 2024-04-24
### Fixed
- fixed Brick Hopper crafting recipe (Fabric, Quilt)
...
### Fixed
- block entities without an item handler above a brick hopper could crash the game (Neoforge) (thanks to randomleech for the report) https://github.com/cech12/WoodenHopper/issues/24
