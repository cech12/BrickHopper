...
public class NeoForgeBrickHopperBlockEntity extends BrickHopperBlockEntity {
    ...
    public static void tick(Level level, BlockPos pos, BlockState state, BrickHopperBlockEntity entity) {
        if (level != null && !level.isClientSide) {
            ...
            if (!entity.isOnTransferCooldown()) {
                ...
                if (entity instanceof NeoForgeBrickHopperBlockEntity blockEntity) {
    ...
    private static ItemStack insertStack(BlockEntity source, Object destination, IItemHandler destInventory, ItemStack stack, int slot) {
        ...
        if (!destInventory.insertItem(slot, stack, true).equals(stack)) {
            ...
            if (result.getCount() < stack.getCount() && inventoryWasEmpty
                    && destination instanceof NeoForgeBrickHopperBlockEntity destinationHopper
                    && !destinationHopper.mayTransfer()
            ) {
                int k = 0;
                if (source instanceof NeoForgeBrickHopperBlockEntity && destinationHopper.getLastUpdateTime() >= ((NeoForgeBrickHopperBlockEntity) source).getLastUpdateTime()) {
                    k = 1;
                }
    ...
    private static Optional<Pair<IItemHandler, Object>> getItemHandler(NeoForgeBrickHopperBlockEntity hopper, Direction hopperFacing) {
     ...
     */
    private static boolean pullItems(NeoForgeBrickHopperBlockEntity hopper) {
    ...
    private static boolean captureItem(NeoForgeBrickHopperBlockEntity hopper, ItemEntity p_200114_1_) {
        boolean flag = false;
    ...
    private static List<ItemEntity> getCaptureItems(NeoForgeBrickHopperBlockEntity p_200115_0_) {
