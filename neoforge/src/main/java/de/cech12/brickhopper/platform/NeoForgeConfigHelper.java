...
public class NeoForgeConfigHelper implements IConfigHelper {
    ...
    static {
        ...
        COOLDOWN = builder
                ...
                .defineInRange("brickHopperCooldown", COOLDOWN_DEFAULT, COOLDOWN_MIN, COOLDOWN_MAX);
        PULL_ITEMS_FROM_WORLD_ENABLED = builder
                .comment(PULL_ITEMS_FROM_WORLD_ENABLED_DESCRIPTION)
                .define("brickHopperPullItemsFromWorldEnabled", PULL_ITEMS_FROM_WORLD_ENABLED_DEFAULT);
        PULL_ITEMS_FROM_INVENTORIES_ENABLED = builder
                .comment(PULL_ITEMS_FROM_INVENTORIES_ENABLED_DESCRIPTION)
                .define("brickHopperPullItemsFromInventoriesEnabled", PULL_ITEMS_FROM_INVENTORIES_ENABLED_DEFAULT);
