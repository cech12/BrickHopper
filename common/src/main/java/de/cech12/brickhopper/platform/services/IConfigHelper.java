...
public interface IConfigHelper {
    ...
    int COOLDOWN_DEFAULT = 12;
    /** Config description of the hoppers cooldown value */
    String COOLDOWN_DESCRIPTION = "Time (ticks) that passes between two brick hopper operations. (default: " + COOLDOWN_DEFAULT + " ticks) (vanilla hopper: 8 ticks)";
    ...
    String PULL_ITEMS_FROM_WORLD_ENABLED_DESCRIPTION = "Whether or not the brick hopper can pull item entities lying above it. (default: " + PULL_ITEMS_FROM_WORLD_ENABLED_DEFAULT + ")";
    ...
    String PULL_ITEMS_FROM_INVENTORIES_ENABLED_DESCRIPTION = "Whether or not the brick hopper can pull items from inventories above it. (default: " + PULL_ITEMS_FROM_INVENTORIES_ENABLED_DEFAULT + ")";
